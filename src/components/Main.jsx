...
import mainPic from "../data/main.jpg";
        ...
        {slides.map((slide) => (
          <div
            ...
            <div className="flex flex-col xl:pt-[30px] fullHD:pt-[50px]">
              <span className="text-[#0D4C93] font-medium tracking-wide 
                w-[100%] md:w-[50%]
              ...
              <span className="text-[#363535] font-normal 
            ...
            <div>
              <img className="h-full mb-[50px] md:mb-0 md:h-[90%] fullHD:h-full" src={mainPic} alt="" />
            </div>
          </div>
        ))}
      </div>
