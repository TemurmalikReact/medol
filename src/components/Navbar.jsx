  ...
  return (
    <>
      ...
      <div className="grid 
        ...
        <div className="hidden md:flex items-center justify-between">
          <div className="flex items-center 
            ...
            <div className="text-[#5A5A5A] font-normal tracking-wide
        ...
        <div className="hidden lg:flex justify-center items-center">
          <img className="lg:w-[150px] lg:h-[40px] xl:w-[150px] xl:h-[40px] fullHD:w-[200px] fullHD:h-[58px]" src={logo} alt="" />
        </div>

        <div className="flex items-center justify-between p-[10px] md:p-0">
          <div className="flex items-center">
            <div className="h-10 w-10 md:w-9 md:h-9 xl:w-10 xl:h-10 fullHD:w-12 fullHD:h-12 
            bg-white rounded-full flex items-center justify-center">
              <svg
                width="26"
                height="26"
          ...
          <div className="hidden md:flex items-center">
            <div className="
              ...
              <span className="text-[#0D4C93] font-normal 
      ...
      <div
        ...
        style={{ gridTemplateColumns: "0.8fr 1fr 1fr 0.8fr 1.2fr 1.2fr" }}>
        {navLinks.map((link, index) => (
          <HashLink
